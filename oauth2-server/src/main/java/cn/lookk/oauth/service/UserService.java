package cn.lookk.oauth.service;

import cn.lookk.oauth.po.User;
...
public class UserService implements UserDetailsService {
    ...
    public void initData() {
        ...
        userList.add(new User("jxy", password, AuthorityUtils.commaSeparatedStringToAuthorityList("admin")));
